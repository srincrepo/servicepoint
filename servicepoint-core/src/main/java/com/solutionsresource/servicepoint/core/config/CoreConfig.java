...
@Configuration
@EnableJpaRepositories("com.solutionsresource.servicepoint.core.repo")
@ComponentScan("com.solutionsresource.servicepoint.core")
public class CoreConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("com.solutionsresource.servicepoint.*.entity");
